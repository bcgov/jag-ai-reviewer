...
KEYCLOAK_REALM_URL="$KEYCLOAK_URL/auth/admin/realms/ai-reviewer"
USERNAME="bobross"
ADMIN_GROUP="ai-reviewer-admins"
...
# Add user to ai-reviewer-admins group
