package ca.bc.gov.open.aidiligenclient.diligen;

import ca.bc.gov.open.aidiligenclient.Keys;
import ca.bc.gov.open.aidiligenclient.diligen.mapper.DiligenDocumentDetailsMapper;
import ca.bc.gov.open.aidiligenclient.diligen.model.DiligenDocumentDetails;
import ca.bc.gov.open.aidiligenclient.diligen.model.DiligenResponse;
...
public class DiligenServiceImpl implements DiligenService {
    ...
    public DiligenDocumentDetails getDocumentDetails(BigDecimal documentId) {
        ...
        try {
            ...
            return diligenDocumentDetailsMapper.toDiligenDocumentDetails(result.getData().getFileDetails(), answersResponse.getData().getFields(), answersResponse);
