package ca.bc.gov.open.aidiligenclient.diligen.diligenServiceImpl;
...
import ca.bc.gov.open.aidiligenclient.diligen.DiligenAuthService;
import ca.bc.gov.open.aidiligenclient.diligen.DiligenProperties;
import ca.bc.gov.open.aidiligenclient.diligen.DiligenServiceImpl;
...
public class PostDocumentTest {
    ...
    public void beforeEach() {
        ...
        sut = new DiligenServiceImpl(restTemplateMock, diligenProperties, diligenAuthServiceMock, objectMapper, null, null);
    ...
    public void withInvalidDocumentIoException() throws IOException {
        ...
        Assertions.assertThrows(DiligenDocumentException.class, () -> sut.postDocument(DOCUMENT_TYPE, mockMultipartFileException, 1));
