...
public class GetRestrictedDocumentTypeTest {
    ...
    public void withValidRequest() {
        ...
        ResponseEntity<ca.bc.gov.open.jag.aireviewerapi.api.model.RestrictedDocumentType> actual = sut.getRestrictedDocumentType(EXISTING_DOCUMENT_ID);
    ...
    public void withMissingDocumentType() {
        ...
        ResponseEntity<ca.bc.gov.open.jag.aireviewerapi.api.model.RestrictedDocumentType> actual = sut.getRestrictedDocumentType(DOCUMENT_ID);
