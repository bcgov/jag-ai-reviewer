...
public class GetDocumentConfigurationsTest {
    ...
    public void shouldReturnAListOfDocumentConfiguration() {
        ...
        ResponseEntity<List<ca.bc.gov.open.jag.aireviewerapi.api.model.DocumentTypeConfiguration>> response = sut.getDocumentConfigurations("");
    ...
    public void shouldReturnASingleOfDocumentConfiguration() {
        ...
        ResponseEntity<List<ca.bc.gov.open.jag.aireviewerapi.api.model.DocumentTypeConfiguration>> response = sut.getDocumentConfigurations(CASE_1);
