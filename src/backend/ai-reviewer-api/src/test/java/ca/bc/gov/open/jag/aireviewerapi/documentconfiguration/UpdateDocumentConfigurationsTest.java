...
public class UpdateDocumentConfigurationsTest {
    ...
    public void withValidDocumentShouldUpdateConfiguration() {
        ...
        ca.bc.gov.open.jag.aireviewerapi.api.model.DocumentTypeConfiguration documentTypeConfigurationRequest = new ca.bc.gov.open.jag.aireviewerapi.api.model.DocumentTypeConfiguration();
        ...
        ResponseEntity<ca.bc.gov.open.jag.aireviewerapi.api.model.DocumentTypeConfiguration> response = sut.updateDocumentTypeConfiguration(documentTypeConfigurationRequest);
